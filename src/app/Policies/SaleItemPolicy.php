...
class SaleItemPolicy
{
    ...
    {
        return $user->can('view_any_sale::item');
    }
    ...
    {
        return $user->can('view_sale::item');
    }
    ...
    {
        return $user->can('create_sale::item');
    }
    ...
    {
        return $user->can('update_sale::item');
    }
    ...
    {
        return $user->can('delete_sale::item');
    }
    ...
    {
        return $user->can('delete_any_sale::item');
    }
     ...
     */
    public function replicate(User $user, SaleItem $saleItem): bool
    {
